 ...
 */
public class TblDBFluteConfig {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** The logger instance for this class. (NotNull) */
    private static final Logger _log = LoggerFactory.getLogger(TblDBFluteConfig.class);

    /** Singleton instance. */
    private static final TblDBFluteConfig _instance = new TblDBFluteConfig();
     ...
     * Constructor.
     */
    private TblDBFluteConfig() { // adjusts default settings
     ...
     */
    public static TblDBFluteConfig getInstance() {
        return _instance;
    }
