 ...
 */
public class TblDBCurrent {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** The logger instance for this class. (NotNull) */
    private static final Logger _log = LoggerFactory.getLogger(TblDBCurrent.class);

    /** Singleton instance. */
    private static final TblDBCurrent _instance = new TblDBCurrent();

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final String _projectName = "twofactor";
    protected final String _projectPrefix = "Tbl";
     ...
     */
    public static TblDBCurrent getInstance() {
        return _instance;
    }
