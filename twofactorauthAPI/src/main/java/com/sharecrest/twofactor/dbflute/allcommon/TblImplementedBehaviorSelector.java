 ...
 */
public class TblImplementedBehaviorSelector implements BehaviorSelector {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** The logger instance for this class. (NotNull) */
    private static final Logger _log = LoggerFactory.getLogger(TblImplementedBehaviorSelector.class);
    ...
    public void initializeConditionBeanMetaData() {
        final Map<String, DBMeta> dbmetaMap = TblDBMetaInstanceHandler.getUnmodifiableDBMetaMap();
    ...
    public BehaviorReadable byName(String tableFlexibleName) {
        ...
        final DBMeta dbmeta = TblDBMetaInstanceHandler.findDBMeta(tableFlexibleName);
