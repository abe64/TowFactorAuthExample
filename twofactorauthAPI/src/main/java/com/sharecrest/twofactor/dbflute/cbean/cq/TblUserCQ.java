...
import com.sharecrest.twofactor.dbflute.cbean.cq.bs.TblBsUserCQ;
 ...
 */
public class TblUserCQ extends TblBsUserCQ {
     ...
     */
    public TblUserCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
