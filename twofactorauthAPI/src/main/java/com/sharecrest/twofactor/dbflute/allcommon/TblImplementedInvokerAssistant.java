 ...
 */
public class TblImplementedInvokerAssistant implements InvokerAssistant {
    ...
    protected TblDBFluteInitializer _introduction;
    ...
    public DBDef assistCurrentDBDef() {
        return TblDBCurrent.getInstance().currentDBDef();
    }
    ...
    public DataSource assistDataSource() { // DI component
        ...
        DataSourceHandler handler = TblDBFluteConfig.getInstance().getDataSourceHandler();
    ...
    protected TblImplementedSqlClauseCreator newImplementedSqlClauseCreator() {
        return new TblImplementedSqlClauseCreator();
    }
    ...
    protected StatementFactory createStatementFactory() {
        ...
        TblDBFluteConfig config = TblDBFluteConfig.getInstance();
    ...
    protected TnBeanMetaDataFactory createBeanMetaDataFactory() {
        ...
        factory.setInternalDebug(TblDBFluteConfig.getInstance().isInternalDebug());
        return factory;
    }
    ...
    protected OutsideSqlExecutorFactory createOutsideSqlExecutorFactory() {
        OutsideSqlExecutorFactory factory = TblDBFluteConfig.getInstance().getOutsideSqlExecutorFactory();
        if (factory != null) {
            return factory;
        }
    ...
    protected SQLExceptionDigger createSQLExceptionDigger() {
        return TblDBFluteConfig.getInstance().getSQLExceptionDigger();
    }
    ...
    protected SequenceCacheHandler createSequenceCacheHandler() {
        ...
        SequenceCacheKeyGenerator generator = TblDBFluteConfig.getInstance().getSequenceCacheKeyGenerator();
        if (generator != null) {
            handler.setSequenceCacheKeyGenerator(generator);
        }
        handler.setInternalDebug(TblDBFluteConfig.getInstance().isInternalDebug());
        return handler;
    }
    ...
    public StatementConfig assistDefaultStatementConfig() {
        return TblDBFluteConfig.getInstance().getDefaultStatementConfig();
    }
    ...
    public GearedCipherManager assistGearedCipherManager() {
        return TblDBFluteConfig.getInstance().getGearedCipherManager();
    }
    ...
    protected ResourceParameter createResourceParameter() {
        ...
        parameter.setOutsideSqlPackage(TblDBFluteConfig.getInstance().getOutsideSqlPackage());
        parameter.setMappingDateTimeZoneProvider(TblDBFluteConfig.getInstance().getMappingDateTimeZoneProvider());
        parameter.setLogDatePattern(TblDBFluteConfig.getInstance().getLogDatePattern());
        parameter.setLogTimestampPattern(TblDBFluteConfig.getInstance().getLogTimestampPattern());
        parameter.setLogTimePattern(TblDBFluteConfig.getInstance().getLogTimePattern());
        parameter.setLogTimeZoneProvider(TblDBFluteConfig.getInstance().getLogTimeZoneProvider());
        parameter.setInternalDebug(TblDBFluteConfig.getInstance().isInternalDebug());
        return parameter;
    }
    ...
    public void setIntroduction(TblDBFluteInitializer introduction) {
