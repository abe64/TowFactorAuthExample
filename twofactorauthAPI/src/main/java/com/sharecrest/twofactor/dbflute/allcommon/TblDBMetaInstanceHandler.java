 ...
 */
public class TblDBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("fixed_mail", "com.sharecrest.twofactor.dbflute.bsentity.dbmeta.TblFixedMailDbm");
        tmpMap.put("flyway_schema_history", "com.sharecrest.twofactor.dbflute.bsentity.dbmeta.TblFlywaySchemaHistoryDbm");
        tmpMap.put("option_data", "com.sharecrest.twofactor.dbflute.bsentity.dbmeta.TblOptionDataDbm");
        tmpMap.put("user", "com.sharecrest.twofactor.dbflute.bsentity.dbmeta.TblUserDbm");
    ...
    //                                                                  Provider Singleton
    //                                                                  ==================
    protected static final DBMetaProvider _provider = new TblDBMetaInstanceHandler();
