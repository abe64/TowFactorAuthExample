 ...
 */
public abstract class TblBsUserBhv extends AbstractBehaviorWritable<TblUser, TblUserCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public TblUserDbm asDBMeta() { return TblUserDbm.getInstance(); }
    /** {@inheritDoc} */
    ...
    //                                                                        ============
    /** {@inheritDoc} */
    public TblUserCB newConditionBean() { return new TblUserCB(); }
     ...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of TblUser. (NotNull)
     * @return The count for the condition. (NotMinus)
     */
    public int selectCount(CBCall<TblUserCB> cbLambda) {
     ...
     */
    public OptionalEntity<TblUser> selectEntity(CBCall<TblUserCB> cbLambda) {
        return facadeSelectEntity(createCB(cbLambda));
    }

    protected OptionalEntity<TblUser> facadeSelectEntity(TblUserCB cb) {
        return doSelectOptionalEntity(cb, typeOfSelectedEntity());
    }

    protected <ENTITY extends TblUser> OptionalEntity<ENTITY> doSelectOptionalEntity(TblUserCB cb, Class<? extends ENTITY> tp) {
     ...
     * <pre>
     * TblUser <span style="color: #553000">user</span> = <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public TblUser selectEntityWithDeletedCheck(CBCall<TblUserCB> cbLambda) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<TblUser> selectByPK(Integer userId) {
        return facadeSelectByPK(userId);
    }

    protected OptionalEntity<TblUser> facadeSelectByPK(Integer userId) {
        return doSelectOptionalByPK(userId, typeOfSelectedEntity());
    }

    protected <ENTITY extends TblUser> ENTITY doSelectByPK(Integer userId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(userId), tp);
    }

    protected <ENTITY extends TblUser> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer userId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(userId, tp), userId);
    }

    protected TblUserCB xprepareCBAsPK(Integer userId) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<TblUser> selectByUniqueOf(String account) {
        return facadeSelectByUniqueOf(account);
    }

    protected OptionalEntity<TblUser> facadeSelectByUniqueOf(String account) {
        return doSelectByUniqueOf(account, typeOfSelectedEntity());
    }

    protected <ENTITY extends TblUser> OptionalEntity<ENTITY> doSelectByUniqueOf(String account, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOf(account), tp), account);
    }

    protected TblUserCB xprepareCBAsUniqueOf(String account) {
        assertObjectNotNull("account", account);
        return newConditionBean().acceptUniqueOf(account);
    }
     ...
     * <pre>
     * ListResultBean&lt;TblUser&gt; <span style="color: #553000">userList</span> = <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (TblUser <span style="color: #553000">user</span> : <span style="color: #553000">userList</span>) {
     *     ... = <span style="color: #553000">user</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of TblUser. (NotNull)
     ...
     */
    public ListResultBean<TblUser> selectList(CBCall<TblUserCB> cbLambda) {
     ...
     * <pre>
     * PagingResultBean&lt;TblUser&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (TblUser user : <span style="color: #553000">page</span>) {
     *     ... = user.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of TblUser. (NotNull)
     ...
     * @throws DangerousResultSizeException When the result size is over the specified safety size.
     */
    public PagingResultBean<TblUser> selectPage(CBCall<TblUserCB> cbLambda) {
     ...
     * </pre>
     * @param cbLambda The callback for condition-bean of TblUser. (NotNull)
     * @param entityLambda The handler of entity row of TblUser. (NotNull)
     */
    public void selectCursor(CBCall<TblUserCB> cbLambda, EntityRowHandler<TblUser> entityLambda) {
     ...
     */
    public <RESULT> HpSLSFunction<TblUserCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     */
    public void load(List<TblUser> userList, ReferrerLoaderHandler<TblLoaderOfUser> loaderLambda) {
        xassLRArg(userList, loaderLambda);
        loaderLambda.handle(new TblLoaderOfUser().ready(userList, _behaviorSelector));
    }
     ...
     * @param loaderLambda The callback to handle the referrer loader for actually loading referrer. (NotNull)
     */
    public void load(TblUser user, ReferrerLoaderHandler<TblLoaderOfUser> loaderLambda) {
        xassLRArg(user, loaderLambda);
        loaderLambda.handle(new TblLoaderOfUser().ready(xnewLRAryLs(user), _behaviorSelector));
    }
     ...
     */
    public List<Integer> extractUserIdList(List<TblUser> userList)
    { return helpExtractListInternally(userList, "userId"); }

    /**
     * Extract the value list of (single) unique key account.
     * @param userList The list of user. (NotNull, EmptyAllowed)
     * @return The list of the column value. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<String> extractAccountList(List<TblUser> userList)
    { return helpExtractListInternally(userList, "account"); }
     ...
     * <pre>
     * TblUser user = <span style="color: #70226C">new</span> TblUser();
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdate(TblUser user) {
     ...
     */
    public int[] batchInsert(List<TblUser> userList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdate(List<TblUser> userList) {
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchDelete(List<TblUser> userList) {
     ...
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;TblUser, TblUserCB&gt;() {
     *     public ConditionBean setup(TblUser entity, TblUserCB intoCB) {
     *         FooCB cb = FooCB();
     *         cb.setupSelect_Bar();
     *
     ...
     */
    public int queryInsert(QueryInsertSetupper<TblUser, TblUserCB> manyArgLambda) {
     ...
     */
    public int queryUpdate(TblUser user, CBCall<TblUserCB> cbLambda) {
     ...
     */
    public int queryDelete(CBCall<TblUserCB> cbLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(TblUser user, WritableOptionCall<TblUserCB, InsertOption<TblUserCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(TblUser user, WritableOptionCall<TblUserCB, UpdateOption<TblUserCB>> opLambda) {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(TblUser user, WritableOptionCall<TblUserCB, InsertOption<TblUserCB>> insertOpLambda, WritableOptionCall<TblUserCB, UpdateOption<TblUserCB>> updateOpLambda) {
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(TblUser user, WritableOptionCall<TblUserCB, DeleteOption<TblUserCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<TblUser> userList, WritableOptionCall<TblUserCB, InsertOption<TblUserCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<TblUser> userList, WritableOptionCall<TblUserCB, UpdateOption<TblUserCB>> opLambda) {
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<TblUser> userList, WritableOptionCall<TblUserCB, DeleteOption<TblUserCB>> opLambda) {
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<TblUser, TblUserCB> manyArgLambda, WritableOptionCall<TblUserCB, InsertOption<TblUserCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(TblUser user, CBCall<TblUserCB> cbLambda, WritableOptionCall<TblUserCB, UpdateOption<TblUserCB>> opLambda) {
     ...
     */
    public int varyingQueryDelete(CBCall<TblUserCB> cbLambda, WritableOptionCall<TblUserCB, DeleteOption<TblUserCB>> opLambda) {
     ...
     */
    public OutsideSqlAllFacadeExecutor<TblUserBhv> outsideSql() {
        return doOutsideSql();
    }
    ...
    //                                                                         Type Helper
    //                                                                         ===========
    protected Class<? extends TblUser> typeOfSelectedEntity() { return TblUser.class; }
    protected Class<TblUser> typeOfHandlingEntity() { return TblUser.class; }
    protected Class<TblUserCB> typeOfHandlingConditionBean() { return TblUserCB.class; }
