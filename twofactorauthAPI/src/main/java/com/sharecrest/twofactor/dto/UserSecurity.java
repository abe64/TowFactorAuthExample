...
@ApiModel(description = "セキュリティ設定変更")
@Data
@SecurityType(twoFactorUse="twoFactorUse", twoFactorType="twoFactorType", telNo="telNo")
@AuthCode(twoFactorUse="twoFactorUse", twoFactorType="twoFactorType", authCode="authCode")
public class UserSecurity {
	...
	@ApiModelProperty(value = "認証コード", example = "123456", position = 30)
